...
command = input("Enter ffmpeg command as shown"
                "(inputfile), (outputfile), (resolution), (bitrate): ")
...
output_video = input_video.filter('scale', resolution[0], resolution[1])\
                         .output(out, vb=bitrate, vcodec='h264_nvenc', acodec='aac', audio_bitrate="128k", preset="fast")
